...
# face_color_data = {face: [[""] * COLS for _ in range(ROWS)] for face in FACES}
...
#         instruction = font.render(f"Color: {selected_color} (Press keys 1-6 to change)", True, (255, 255, 255))
